...
<body>
	...
	<form action="serviceAction!add3MyService" method="post"
		onsubmit="return checkForm();">
		<input type="hidden" name="myService.status" value="4">
		选择任务：<select name=mid id="mid">
					<option value="0">--选择--</option>
				</select><br>
		服务反馈：<input name="myService.request">
		服务满意度：<input name="myService.satisfy">
		...
		<hr>
			<div class="border">
 		<h1><img src="mainfile/customer/images/menu/khlb.png" border="0">&nbsp;已处理待反馈</h1>
 	</div>
	<div class="border">
